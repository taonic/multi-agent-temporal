...
from examples.multiagent_slack.schemas import ChannelSchema, SearchSchema, ThreadSchema
    ...
    try:
        ...
        if user_input.strip().startswith('{') and user_input.strip().endswith('}'):
            try:
                ...
                result = await agent.prompt(structured_input)
...
def print_welcome_message():
    ...
    print("You can also use structured input format:")
    print('  • {"query_type": "search", "topic": "product features", "time_range": "last week"}')
    print('  • {"query_type": "thread", "url": "https://temporaltechnologies.slack.com/archives/ABCDEF/1234567890123456"}')
...
async def main():
    ...
    #     model_name="models/gemini-2.5-pro-preview-05-06",
    #     instruction="You analyze and summarize Slack conversation threads.",
